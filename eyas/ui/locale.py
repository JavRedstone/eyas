...
MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "labels.simple_theme": "Simple Theme",
        "labels.theme_help": "Pick a color and mode, then click **Save**. Restart the server to apply.",
        "labels.color": "Color",
        "labels.mode": "Mode",
        "labels.advanced_theme": "Advanced Theme",
        "labels.advanced_theme_help": (
        ...
        "buttons.save_theme": "Save theme",
        "buttons.save_advanced_theme": "Save advanced theme",
        ...
        "splash.models.yolo": "Object Detector (YOLO)",
        "splash.models.vlm": "Visual Language Model",
        ...
        "status.theme_saved": "Saved **{color} · {mode}**. Restart the server to apply.",
        "status.theme_save_error": "Error saving preferences: {error}",
        "status.advanced_saved": "Saved **{theme}**. Restart the server to apply.",
        "status.unknown_theme": "Unknown advanced theme: {theme}",
    ...
    "ko": {
        ...
        "labels.clips": "클립",
        "labels.preview": "미리보기",
        "labels.simple_theme": "간단 테마",
        "labels.theme_help": "색상과 모드를 선택한 후 **저장**을 클릭하세요. 서버를 재시작해야 적용됩니다.",
        "labels.color": "색상",
        "labels.mode": "모드",
        "labels.advanced_theme": "고급 테마",
        "labels.advanced_theme_help": (
            "실제 프로덕션 웹사이트의 DESIGN.md 팔레트. "
            "`designs/`에서 소스 파일을 확인하세요."
        ),
        "labels.language": "언어",
        ...
        "buttons.delete": "삭제",
        "buttons.save_theme": "테마 저장",
        "buttons.save_advanced_theme": "고급 테마 저장",
        ...
        "splash.models.yolo": "객체 탐지기 (YOLO)",
        "splash.models.vlm": "시각 언어 모델",
        ...
        "status.theme_saved": "**{color} · {mode}** 저장됨. 서버를 재시작하세요.",
        "status.theme_save_error": "설정 저장 오류: {error}",
        "status.advanced_saved": "**{theme}** 저장됨. 서버를 재시작하세요.",
        "status.unknown_theme": "알 수 없는 고급 테마: {theme}",
...
SPLASH_MODEL_KEYS = {"yolo": "splash.models.yolo", "vlm": "splash.models.vlm", "llm": "splash.models.llm"}
